...
cp -rv styles/shared/style_unstable/drawer.css styles/shared/style_unstable/lists.css ../dist/styles/shared/style_unstable/

# add used Firefox CSS images
cp -rv images/drawer images/headers images/input_areas images/status ../dist/images/
